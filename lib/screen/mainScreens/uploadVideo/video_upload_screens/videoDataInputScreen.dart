...
class _VideoDataInputState extends State<VideoDataInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Platform.isIOS ? VideoDataInputIOS(dataInputBody: dataInputBody(),uploadDraftToServer: uploadDraftToServer,draftSaved: _draftSaved,) : Scaffold(
