...
class _VideoPreviewState extends State<VideoPreview> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Platform.isIOS ? VideoPreviewIOS(previewBody: previewBody(),previewBottomNav: previewBottomNav(),) :  Scaffold(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  currPos(),
                  Text(_controller.value.duration==null ? "":trimDuration(_controller.value.duration),style: TextStyle(color: AppTheme.pureWhiteColor),)
                ],
              ),
            ),
          ],
