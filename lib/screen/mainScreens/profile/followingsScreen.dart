...
class _FollowingsPageState extends State<FollowingsPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Platform.isIOS
        ? FollowingScreenIOS(followingBody: followingBody(),)
        : Scaffold(
                            ...
                            secondaryActions: <Widget>[
                              IconSlideAction(
                                  ...
                                  onTap: () async {
                                    ...
                                    print("bool: $result");
                                    if (!result) {
                                      Platform.isIOS ? cupertinoSnackbar(_listKey.currentContext,"Unfollowed Successfully"):
                                      _scaffoldGlobalKey.currentState
                                          .showSnackBar(SnackBar(
                                          content: Text(
                                              'Unfollowed successfully')));
                                    } else {
                                      Platform.isIOS ?  cupertinoSnackbar(context, "Something Went Wrong"):_scaffoldGlobalKey.currentState
                                          .showSnackBar(SnackBar(
                                          content: Text(
                                              'Something went wrong')));
                                    }
